...
namespace AlgoJudge.Server.Database.Migrations
{
    ...
    [Migration("20260918195016_americanSpelling")]
    partial class americanSpelling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlgoJudge.Server.Database.Models.Grant", b =>
                {
                    ...
                    b.Property<string>("CopiedFromRoleName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AlgoJudge.Server.Database.Models.Activity", b =>
                {
                    b.HasOne("AlgoJudge.Server.Database.Models.Role", "ManagerRole")
                        .WithMany()
                        .HasForeignKey("ManagerRoleId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AlgoJudge.Server.Database.Models.Role", "ParticipantRole")
                        .WithMany()
